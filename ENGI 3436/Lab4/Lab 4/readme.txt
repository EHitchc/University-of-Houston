...
- Abatron BDI:
  This Connection allows to debug using the BDM connector
  with Abatron hardware (BDI-HS or BDI1000).
  The BDI-HS or BDI1000 boxes connect via the host serial
  port or via Ethernet.
  Please check the Abatron documentation for additional details.
