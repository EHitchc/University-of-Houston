function [] = PERPENDICULAR_POLAR_CRIT_ANGLE( E0, u, w, theta, k0, Er1, ur1, Er2, ur2, x_neg, x_pos, x)
    k1 = k0 * sqrt(Er1 * ur1);
    k2 = k0 * sqrt(Er2 * ur2);
    ...
    xlabel('z [m]');
    ylabel('|Ey| in [V/m]');
    title('Plot of E-field vs Z for Air -> Dielectric (Er = 4,ur = 1), Perpendicular Polarization');
    ...
    xlabel('z [m]');
    ylabel('|Hx| in [A/m]');
    title('Plot of H-field vs Z for Air -> Dielectric (Er = 4,ur = 1), Perpendicular Polarization');
